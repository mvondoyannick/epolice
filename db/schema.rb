...
ActiveRecord::Schema.define(version: 2018_12_05_202635) do
  ...
  create_table "modepaiements", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "status"
  ...
  create_table "post_commissariats", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "commissariat_id"
    t.bigint "agent_id"
    t.bigint "grade_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["agent_id"], name: "index_post_commissariats_on_agent_id"
    t.index ["commissariat_id"], name: "index_post_commissariats_on_commissariat_id"
    t.index ["grade_id"], name: "index_post_commissariats_on_grade_id"
  end
  ...
  create_table "zonecouverturemotifs", id: :bigint, default: nil, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.string "detail"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
