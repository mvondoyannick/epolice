class Convocation < ApplicationRecord
    ...
    def send_sms
        message = "Le numero #{self.phone} enregistre a la Piece d identite #{self.cni} a ete VERBALISE pour des motifs de la voie publique: Plus d'information a l adresse http://pop-circulation.herokuapp.com/public/verbal/#{self.code.upcase}. Presenter ce code pour paiement #{self.code}.upcase "
