class Postepolice < ApplicationRecord
  ...
  validates_presence_of :name, presence: true, presence: {message: 'Merci de fournir le nom du poste.'}
  validates_presence_of :location, presence: true, presence: {message: 'Merci de decrire la localisation'}
end
