#integration de Onesignal pour la notification des applications clientes
...
class OneSignals
  ...
  HEADERS = { "Authorization" => "Basic YWJkNzQwYzAtMmYyNC00MDY2LTlmYTMtZjI0ZDc4ZTljMDk5", "Content-Type" => "application/json" }
