...
Rails.application.config.assets.precompile += %w( datatables.net-bs/css/dataTables.bootstrap.min.css )
Rails.application.config.assets.precompile += %w( datatables.net-bs/js/dataTables.bootstrap.min.js )
Rails.application.config.assets.precompile += %w( datatables.net/js/jquery.dataTables.min.js )
